...
var loadUserData = function() {
    ...
    if (!storedProfile) {
        ...
        if (userProfileObj.matchData.analytics) {
            loadMatchData();
        };
    };
...
var loadMatchData = function() {
    var analyticsObj = userProfileObj.matchData.analytics;
    // re-initialize variables with stored values
        ...
        if (e.isFinal) {
            ...
            if (successful) {
                ...
                if (love == true && loveMatch == true) {
                    // check which to increment
                    incrementCatDogMatch(this.topCard);
                    match++;
...
function incrementCatDogMatch(topCard) {
